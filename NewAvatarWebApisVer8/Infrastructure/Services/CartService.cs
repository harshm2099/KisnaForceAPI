...
namespace NewAvatarWebApis.Infrastructure.Services
{
    public class CartService : ICartService
    {
        ...
        private readonly ISoapSolitaireService _soapSoliraireService;

        public CartService(ISoapSolitaireService soapSolitaireService)
        {
            _soapSoliraireService = soapSolitaireService;
        }
        ...
        public async Task<ReturnResponse> CartInsert(CartInsertParams param, CommonHeader header)
        {
            ...
            try
            {
                using (SqlConnection dbConnection = new SqlConnection(_connection))
                {
                    string cmdQuery = DBCommands.CartInsert;
                    dbConnection.Open();

                    using (SqlCommand cmd = new SqlCommand(cmdQuery, dbConnection))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@data_id", param.data_id);
                        cmd.Parameters.AddWithValue("@net_ip", param.net_ip);
                        cmd.Parameters.AddWithValue("@item_id", param.item_id);
                        cmd.Parameters.AddWithValue("@cart_price", param.cart_price);
                        cmd.Parameters.AddWithValue("@cart_qty", param.cart_qty);
                        cmd.Parameters.AddWithValue("@cart_remark", param.cart_remark);
                        cmd.Parameters.AddWithValue("@cart_id", param.cart_id);
                        cmd.Parameters.AddWithValue("@is_stock", param.is_stock);
                        cmd.Parameters.AddWithValue("@cart_mrprice", param.cart_mrprice);
                        cmd.Parameters.AddWithValue("@cart_rprice", param.cart_rprice);
                        cmd.Parameters.AddWithValue("@cart_dprice", param.cart_dprice);
                        cmd.Parameters.AddWithValue("@product_color_mst_id", param.product_color_mst_id);
                        cmd.Parameters.AddWithValue("@product_size_mst_id", param.product_size_mst_id);
                        cmd.Parameters.AddWithValue("@product_item_remarks", param.product_item_remarks);
                        cmd.Parameters.AddWithValue("@product_item_remarks_ids", param.product_item_remarks_ids);
                        cmd.Parameters.AddWithValue("@product_item_custom_remarks", param.product_item_custom_remarks);
                        cmd.Parameters.AddWithValue("@product_item_custom_remarks_ids", param.product_item_custom_remarks_ids);
                        cmd.Parameters.AddWithValue("@product_item_custom_remarks_status", param.product_item_custom_remarks_status);
                        cmd.Parameters.AddWithValue("@extra_gold", param.extra_gold);
                        cmd.Parameters.AddWithValue("@extra_gold_price", param.extra_gold_price);
                        cmd.Parameters.AddWithValue("@ItemAproxDayCommonID", param.ItemAproxDayCommonID);
                        cmd.Parameters.AddWithValue("@devicetype", header.devicetype);
                        cmd.Parameters.AddWithValue("@devicename", header.devicename);
                        cmd.Parameters.AddWithValue("@appversion", header.appversion);
        ...
        {
            var responseDetails = new ResponseDetails();
            IList<CartItemResponse> cartItemList = new List<CartItemResponse>();
            try
            {
                using (SqlConnection dbConnection = new SqlConnection(_connection))
                {
                    string cmdQuery = DBCommands.CartItemList;
                    await dbConnection.OpenAsync();
                                ...
                                if (ds.Tables[0].Rows.Count > 0)
                                {
                                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                                    {
                                        try
                                        {
                                            ...
                                            string? dislabourPer = rowdetails["dislabour_per"] != DBNull.Value ? Convert.ToString(rowdetails["dislabour_per"]) : string.Empty;
                                            ...
                                            string? ExtraGoldWeight = rowdetails["ExtraGoldWeight"] != DBNull.Value ? Convert.ToString(rowdetails["ExtraGoldWeight"]) : string.Empty;
                                            string? ExtraGoldPrice = rowdetails["ExtraGoldPrice"] != DBNull.Value ? Convert.ToString(rowdetails["ExtraGoldPrice"]) : string.Empty;
                                            string? cartIds = rowdetails["cart_id"] != DBNull.Value ? Convert.ToString(rowdetails["cart_id"]) : string.Empty;
                                            ...
                                            string? entDate = rowdetails["ent_dt"] != DBNull.Value ? Convert.ToString(rowdetails["ent_dt"]) : string.Empty;
                                            ...
                                            string? isStock = rowdetails["is_stock"] != DBNull.Value ? Convert.ToString(rowdetails["is_stock"]) : string.Empty;
                                            string? productItemCustomRemarksStatus = rowdetails["product_item_custom_remarks_status"] != DBNull.Value ? Convert.ToString(rowdetails["product_item_custom_remarks_status"]) : string.Empty;
                                            ...
                                            string? imgWatchTitle2 = rowdetails["img_watch_title2"] != DBNull.Value ? Convert.ToString(rowdetails["img_watch_title2"]) : string.Empty;
                                            ...
                                            string? itemDiamond_details = rowdetails["item_diamond_details"] != DBNull.Value ? Convert.ToString(rowdetails["item_diamond_details"]) : string.Empty;
                                            ...
                                            string? SNMCCFlag = rowdetails["SNMCCFlag"] != DBNull.Value ? Convert.ToString(rowdetails["SNMCCFlag"]) : string.Empty;
                                            ...
                                            string? cartItemID = rowdetails["CartItemID"] != DBNull.Value ? Convert.ToString(rowdetails["CartItemID"]) : string.Empty;
                                            string? indentNumber = rowdetails["indentNumber"] != DBNull.Value ? Convert.ToString(rowdetails["indentNumber"]) : string.Empty;
                                            string? itemIllumine = rowdetails["item_illumine"] != DBNull.Value ? Convert.ToString(rowdetails["item_illumine"]) : string.Empty;
                                            string? itemIsSRP = rowdetails["ItemIsSRP"] != DBNull.Value ? Convert.ToString(rowdetails["ItemIsSRP"]) : string.Empty;
                                            string? isAutoInserted = rowdetails["isAutoInserted"] != DBNull.Value ? Convert.ToString(rowdetails["isAutoInserted"]) : string.Empty;
                                            string? isCOOInserted = rowdetails["isCOOInserted"] != DBNull.Value ? Convert.ToString(rowdetails["isCOOInserted"]) : string.Empty;
                                            string? itemValidSts = rowdetails["ItemValidSts"] != DBNull.Value ? Convert.ToString(rowdetails["ItemValidSts"]) : string.Empty;
                                            ...
                                            string? itemSubCtgCommonID = rowdetails["ItemSubCtgCommonID"] != DBNull.Value ? Convert.ToString(rowdetails["ItemSubCtgCommonID"]) : string.Empty;
                                            string? isConsumerOrder = rowdetails["IsConsumerOrder"] != DBNull.Value ? Convert.ToString(rowdetails["IsConsumerOrder"]) : string.Empty;
                                            string? isSolitaireAvailable = rowdetails["isSolitaireAvailable"] != DBNull.Value ? Convert.ToString(rowdetails["isSolitaireAvailable"]) : string.Empty;
                                            ...
                                            string? franDiamondPrice = rowdetails["fran_diamond_price"] != DBNull.Value ? Convert.ToString(rowdetails["fran_diamond_price"]) : string.Empty;
                                            string? franGoldPrice = rowdetails["fran_gold_price"] != DBNull.Value ? Convert.ToString(rowdetails["fran_gold_price"]) : string.Empty;
                                            string? franPlatinumPrice = rowdetails["fran_platinum_price"] != DBNull.Value ? Convert.ToString(rowdetails["fran_platinum_price"]) : string.Empty;
                                            string? franLabourPrice = rowdetails["fran_labour_price"] != DBNull.Value ? Convert.ToString(rowdetails["fran_labour_price"]) : string.Empty;
                                            string? franMetalPrice = rowdetails["fran_metal_price"] != DBNull.Value ? Convert.ToString(rowdetails["fran_metal_price"]) : string.Empty;
                                            string? franOtherPrice = rowdetails["fran_other_price"] != DBNull.Value ? Convert.ToString(rowdetails["fran_other_price"]) : string.Empty;
                                            string? franStonePrice = rowdetails["fran_stone_price"] != DBNull.Value ? Convert.ToString(rowdetails["fran_stone_price"]) : string.Empty;
                                            ...
                                            string? cartSoliStkNo = rowdetails["CartSoliStkNo"] != DBNull.Value ? Convert.ToString(rowdetails["CartSoliStkNo"]) : string.Empty;
                                            string? isEarPiercing = rowdetails["isEarPiercing"] != DBNull.Value ? Convert.ToString(rowdetails["isEarPiercing"]) : string.Empty;
                                            string? isSolitaireCombo = rowdetails["IsSolitaireCombo"] != DBNull.Value ? Convert.ToString(rowdetails["IsSolitaireCombo"]) : string.Empty;
                                            ...
                                            string? defaultColorNode = rowdetails["default_color_code"] != DBNull.Value ? Convert.ToString(rowdetails["default_color_code"]) : string.Empty;
                                            ...
                                            var cartItem = new CartItemResponse
                                            {
                                                ...
                                                LabourPer = labourPer,
                                                DislabourPer = dislabourPer,
                                                Plaingoldstatus = plainGoldStatus,
                                                ExtraGoldWeight = ExtraGoldWeight,
                                                ExtraGoldPrice = ExtraGoldPrice,
                                                CartId = cartIds,
                                                ItemDAproxDay = itemDAproxDay,
                                                DataId = dataIds,
                                                DsgKt = dsgKt,
                                                ...
                                                IsStock = isStock,
                                                ProductItemCustomRemarksStatus = productItemCustomRemarksStatus,
                                                ...
                                                ItemDiamondDetails = itemDiamond_details,
                                                ItemText = itemText,
                                                ...
                                                IndentNumber = indentNumber,
                                                ItemIllumine = itemIllumine,
                                                ItemIsSRP = itemIsSRP,
                                                IsAutoInserted = isAutoInserted,
                                                IsCOOInserted = isCOOInserted,
                                                ItemValidSts = itemValidSts,
                                                ItemSizeAvailable = itemSizeAvailable,
                                                ItemSubCtgCommonID = itemSubCtgCommonID,
                                                IsConsumerOrder = isConsumerOrder,
                                                IsSolitaireAvailable = isSolitaireAvailable,
                                                Weight = weight,
                                                TotalLabourPer = totalLabourPer,
                                                FranDiamondPrice = franDiamondPrice,
                                                Fran_GoldPrice = franGoldPrice,
                                                FranPlatinumPrice = franPlatinumPrice,
                                                FranLabourPrice = franLabourPrice,
                                                FranMetalPrice = franMetalPrice,
                                                FranOtherPrice = franOtherPrice,
                                                FranStonePrice = franStonePrice,
                                                FieldName = fieldName,
                                                ...
                                                IsSolitaireCombo = isSolitaireCombo,
                                                SelectedColor = selectedColor,
                                                SelectedColor1 = selectedColor1,
                                                SelectedSize1 = selectedSize1,
                                                ColorName = colorName,
                                                DefaultColorName = defaultColorName,
                                                DefaultColorCode = defaultColorNode,
                                            };

                                            if (cartItem.ItemSoliter == "Y" || cartItem.ItemIllumine == "Y")
                                            {
                                                await _soapSoliraireService.ProcessSolitaireAvailabilityAsync(cartItem);
                                            }
                                            else
                                            {
                                                if (string.IsNullOrEmpty(cartItem.IsSolitaireAvailable))
                                                {
                                                    cartItem.IsSolitaireAvailable = "N/A";
                                                }
                                            }
                ...
                else
                {
                    ...
                    responseDetails.message = "No data found";
                    responseDetails.status = "200";
                    responseDetails.data = new List<CartItemResponse>();
                }
                return responseDetails;
            }
            catch (SqlException sqlEx)
