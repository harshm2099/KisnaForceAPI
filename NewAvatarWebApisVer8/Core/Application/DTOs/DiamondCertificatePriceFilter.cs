...
{
    public class DiamondCertificatePriceFilter
    {
        ...
        public class DiamondCertificatePriceFilter_Static
        {  
            ...
            public IList<DiamondCertificatePriceFilter_Records> data { get; set; }
        }
        public class DiamondCertificatePriceFilter_Records
        {   
